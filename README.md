...
| [fetch](/nodejs/http/fetch.options.PoC.js)                                        | `method`; `body`; `referrer`                                                    | Privilege Escalation               |                                                                                                        | TBA                                                                                                                                                                 |
| [fetch](/nodejs/http/fetch.socketPath.PoC.js)                                     | `socketPath`                                                                    | SSRF                               |                                                                                                        | TBA                                                                                                                                                                 |
| [http.get](/nodejs/http/get.options.PoC.js)                                       | `hostname`, `headers`, `method`, `path`, `port`                                 | SSRF                               |                                                                                                        | TBA                                                                                                                                                                 |
| [http.request](/nodejs/http/request.options.PoC.js)                               | `hostname`, `headers`, `method`, `path`, `port`                                 | SSRF                               |                                                                                                        | TBA                                                                                                                                                                 |
| [http.Server.listen](/nodejs/http/listen.host.PoC.js)                             | `backlog`                                                                       | Segfault                           |                                                                                                        | TBA                                                                                                                                                                 |
| [https.get](/nodejs/https/get.options.PoC.js)                                     | `hostname`, `headers`, `method`, `path`, `port`, `NODE_TLS_REJECT_UNAUTHORIZED` | SSRF                               |                                                                                                        | TBA                                                                                                                                                                 |
| [https.request](/nodejs/https/request.options.PoC.js)                             | `hostname`, `headers`, `method`, `path`, `port`, `NODE_TLS_REJECT_UNAUTHORIZED` | SSRF                               |                                                                                                        | TBA                                                                                                                                                                 |
| [import](/nodejs/import/import.source.PoC.js)                                     | `source`                                                                        | ACE                                |                                                                                                        | TBA                                                                                                                                                                 |
| [tls.connect](/nodejs/https/tls.connect.PoC.js)                                   | `path`, `port`, `NODE_TLS_REJECT_UNAUTHORIZED`                                  | Second order SSRF                  |                                                                                                        | TBA                                                                                                                                                                 |
...
| [require](/nodejs/require/require.main2.PoC.js)                                   | `main`; `NODE_OPTIONS`                                                          | ACI                                | :warning: Fixed in v18.19.0. Requires the absence of `package.json` in the directory from the argument | TBA                                                                                                                                                                 |
| [Worker.constructor](/nodejs/working_threads/ctor.PoC.js)                         | `argv`, `env`, `eval`                                                           | Second order ACE and env injection |                                                                                                        | TBA                                                                                                                                                                 |
...
| [Deno.makeTempDirSync](/deno/Deno/makeTempDir/makeTempDirSync.prefix.PoC.ts)         | `prefix`                             | Path Traversal              | Limited by file system permissions`*` | TBA      |
| [Deno.makeTempFile](/deno/Deno/makeTempFile/makeTempFile.dir.PoC.ts)                 | `dir`                                | Path Traversal              | Limited by file system permissions    | TBA      |
| [Deno.makeTempFile](/deno/Deno/makeTempFile/makeTempFile.prefix.PoC.ts)              | `prefix`                             | Path Traversal              | Limited by file system permissions`*` | TBA      |
| [Deno.makeTempFileSync](/deno/Deno/makeTempFile/makeTempFileSync.dir.PoC.ts)         | `dir`                                | Path Traversal              | Limited by file system permissions    | TBA      |
| [Deno.makeTempFileSync](/deno/Deno/makeTempFile/makeTempFileSync.prefix.PoC.ts)      | `prefix`                             | Path Traversal              | Limited by file system permissions`*` | TBA      |
| [Deno.mkdir](/deno/Deno/mkdir/mkdir.mode.PoC.ts)                                     | `mode`                               | Privilege Escalation        | `options` must not be undefined       | TBA      |
| [Deno.mkdirSync](/deno/Deno/mkdir/mkdirSync.mode.PoC.ts)                             | `mode`                               | Privilege Escalation        | `options` must not be undefined       | TBA      |
| [Deno.open](/deno/Deno/open/open.append.PoC.ts)                                      | `append`                             | Unauthorized Modifications  |                                       | TBA      |
| [Deno.open](/deno/Deno/open/open.mode.PoC.ts)                                        | `mode`                               | Privilege Escalation        |                                       | TBA      |
| [Deno.open](/deno/Deno/open/open.truncate.PoC.ts)                                    | `truncate`                           | Unauthorized Modifications  |                                       | TBA      |
| [Deno.openSync](/deno/Deno/open/open.append.PoC.ts)                                  | `append`                             | Unauthorized Modifications  |                                       | TBA      |
| [Deno.openSync](/deno/Deno/open/open.mode.PoC.ts)                                    | `mode`                               | Privilege Escalation        |                                       | TBA      |
| [Deno.openSync](/deno/Deno/open/open.truncate.PoC.ts)                                | `truncate`                           | Unauthorized Modifications  |                                       | TBA      |
| [Deno.writeFile](/deno/Deno/writeFile/writeFile.append.PoC.ts)                       | `append`                             | Unauthorized Modifications  |                                       | TBA      |
| [Deno.writeFile](/deno/Deno/writeFile/writeFile.mode.PoC.ts)                         | `mode`                               | Privilege Escalation        | Affects new and existing files        | TBA      |
| [Deno.writeFileSync](/deno/Deno/writeFile/writeFileSync.append.PoC.ts)               | `append`                             | Unauthorized Modifications  |                                       | TBA      |
| [Deno.writeFileSync](/deno/Deno/writeFile/writeFileSync.mode.PoC.ts)                 | `mode`                               | Privilege Escalation        | Affects new and existing files        | TBA      |
| [Deno.writeTextFile](/deno/Deno/writeTextFile/writeTextFile.append.PoC.ts)           | `append`                             | Unauthorized Modifications  |                                       | TBA      |
| [Deno.writeTextFile](/deno/Deno/writeTextFile/writeTextFile.mode.PoC.ts)             | `mode`                               | Privilege Escalation        | Affects new and existing files        | TBA      |
| [Deno.writeTextFileSync](/deno/Deno/writeTextFile/writeTextFileSync.append.PoC.ts)   | `append`                             | Unauthorized Modifications  |                                       | TBA      |
| [Deno.writeTextFileSync](/deno/Deno/writeTextFile/writeTextFileSync.mode.PoC.ts)     | `mode`                               | Privilege Escalation        | Affects new and existing files        | TBA      |
| [Deno.run](/deno/Deno/run/run.cwd.PoC.ts)                                            | `cwd`                                | Path Traversal              |                                       | TBA      |
| [Deno.run](/deno/Deno/run/run.uid.PoC.ts)                                            | `uid`                                | Privilege Escalation        | unstable option                       | TBA      |
| [Deno.run](/deno/Deno/run/run.gid.PoC.ts)                                            | `gid`                                | Privilege Escalation        | unstable option                       | TBA      |
| [Deno.Command](/deno/Deno/Command/Command.cwd.PoC.ts)                                | `cwd`                                | Path Traversal              |                                       | TBA      |
| [Deno.Command](/deno/Deno/Command/Command.uid.PoC.ts)                                | `uid`                                | Privilege Escalation        |                                       | TBA      |
| [Deno.Command](/deno/Deno/Command/Command.gid.PoC.ts)                                | `gid`                                | Privilege Escalation        |                                       | TBA      |
| [node:child_process.spawn](/deno/node/child_process/spawn.uid.PoC.ts)                | `uid`                                | Privilege Escalation        |                                       | TBA      |
| [node:child_process.spawn](/deno/node/child_process/spawn.gid.PoC.ts)                | `gid`                                | Privilege Escalation        |                                       | TBA      |
| [node:child_process.spawn](/deno/node/child_process/spawn.env.PoC.ts)                | `shell`; `env`                       | Arbitrary Code Execution    | Limited by run permissions            | TBA      |
| [node:child_process.spawnSync](/deno/node/child_process/spawnSync.env.PoC.ts)        | `shell`; `env`                       | Arbitrary Code Execution    | Limited by run permissions            | TBA      |
| [node:child_process.exec](/deno/node/child_process/exec.env.PoC.ts)                  | `shell`; `env`                       | Arbitrary Code Execution    | Limited by run permissions            | TBA      |
| [node:child_process.execSync](/deno/node/child_process/execSync.env.PoC.ts)          | `shell`; `env`                       | Arbitrary Code Execution    | Limited by run permissions            | TBA      |
| [node:child_process.execFileSync](/deno/node/child_process/execFileSync.env.PoC.ts)  | `shell`; `env`                       | Arbitrary Code Execution    | Limited by run permissions            | TBA      |
| [node:fs.appendFile](/deno/node/fs/appendFile.length.PoC.ts)                         | `length`                             | Hanging                     | Can't be prevented (not an option)    | TBA      |
| [node:fs.appendFile](/deno/node/fs/appendFile.offset.PoC.ts)                         | `offset`                             | Out of Memory               | Can't be prevented (not an option)    | TBA      |
| [node:fs.writeFile](/deno/node/fs/writeFile.length.PoC.ts)                           | `length`                             | Hanging                     | Can't be prevented (not an option)    | TBA      |
| [node:fs.writeFile](/deno/node/fs/writeFile.offset.PoC.ts)                           | `offset`                             | Out of Memory               | Can't be prevented (not an option)    | TBA      |
| [node:http.request](/deno/node/http/request.hostname.PoC.ts)                         | `hostname`; `method`; `path`; `port` | Server Side Request Forgery | Limited by network permissions        | TBA      |
| [node:https.request](/deno/node/https/request.hostname.PoC.ts)                       | `hostname`; `method`; `path`; `port` | Server Side Request Forgery | Limited by network permissions        | TBA      |
| [node:zlib.createBrotliCompress](/deno/node/zlib/createBrotliCompress.params.PoC.ts) | `params`                             | Panic                       |                                       | TBA      |
...
| [yaml.stringify](/deno/std/yaml/stringify.indent.PoC.ts)                             | `indent`                             | Out of Memory               |                                       | TBA      |
